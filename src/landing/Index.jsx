            ...
            <div className="container grid grid-rows-[0.25fr_2fr] w-full h-full">
                ...
                <section className="w-full h-full">
                    <article className=" w-full max-w-[62em] mt-[clamp(4rem,8vw,7rem)]">
                        <img src="/public/users.png" alt="" className="w-full max-w-[10rem] mobile:mb-2" />
                ...
                <img src="/public/video.png" alt="" className=" cursor-pointer absolute bottom-10 right-10 w-full max-w-[30rem] mobile:max-w-[20rem]" />
            </div>
        </main>
    )
}
